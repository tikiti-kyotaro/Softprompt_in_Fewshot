...
if __name__ == '__main__':
    ...
    # parser.add_argument('--tuning_mode', type=str, default='finetune', help='')  # finetuneにしてるから注意！！！！！
    parser.add_argument('--optim_prefix', type=str, default='yes', help='')
    parser.add_argument('--preseqlen', type=int, default=30, help='')  # soft prompt のトークン数
    ...
    parser.add_argument('--notes', type=str, default=None, help='')  # prefixtune だったら指定されない？
    ...
    # Added by MX
    # parser.add_argument('--cache_dir', type=str, default='/u/scr/xlisali/contrast_LM/transformers/examples/control', help='cache dir')  # 変更点
    parser.add_argument('--cache_dir', type=str, default='/home/kyotaro/prompt-order/PrefixTuning/cache', help='cache dir')
    ...
    if args.mode == 'data2text':
        ...
        #TRAIN_FILE = "/u/scr/xlisali/WebNLG/webnlg-dataset/webnlg_challenge_2017/train.json"   # 変更点
        #TEST_FILE = "/u/scr/xlisali/WebNLG/webnlg-dataset/webnlg_challenge_2017/dev.json"  # 変更点
        TRAIN_FILE = "/home/kyotaro/prompt-order/PrefixTuning/data/webnlg_challenge_2017/train.json"
        TEST_FILE = "/home/kyotaro/prompt-order/PrefixTuning/data/webnlg_challenge_2017/test.json"
    ...
    elif args.mode == 'classify-sentiment':    # 変更点（SST-2）
        folder_name = "SST-2_models-finetune/"
        TRAIN_FILE = "/home/kyotaro/prompt-order/SST-2/new/train.txt"  # 変変
        TEST_FILE = "/home/kyotaro/prompt-order/SST-2/new/dev.txt"  # 変変
    ...
    if args.notes is not None:
        ...
        args.notes = 'o={}'.format(args.objective_mode)  # args.notes 指定
    ...
    if args.dir_name is None:
        Model_FILE = args.mode + args.tuning_mode + '_' + args.optim_prefix[:1] + '_' + str(args.preseqlen) + \
                     ...
                     '_m={}'.format(args.mid_dim)  # model が生成される場所
    else:
        Model_FILE = dir_name
    ...
    COMMANDLINE="python /home/kyotaro/prompt-order/PrefixTuning/gpt2/run_language_modeling.py \
        --output_dir={} \
        --model_type=gpt2 \
        --model_name_or_path={} \
        --tokenizer_name={} \
        ...
        # --output_dir：モデルが生成される場所, --model_name_or_path：gpt2, --tokenizer_name：gpt2, --per_device_train_batch_size：10, --per_device_train_batch_size : 10, --epoch : 5, --train_data_file : 訓練データ, --task_mode : classify-sentiment, --eval_data_file : devデータ, --tuning_mode : prefixtune, 
